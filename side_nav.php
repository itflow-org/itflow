...
<ul class="sidebar navbar-nav">
  ...
  <li class="nav-item dropdown">
    ...
    <div class="dropdown-menu" aria-labelledby="pagesDropdown">
      <a class="dropdown-item" href="register.html">Income Summary</a>
      <a class="dropdown-item" href="forgot-password.html">Expense Summary</a>
      <a class="dropdown-item" href="forgot-password.html">Income vs Expense</a>
      <a class="dropdown-item" href="login.html">Profit & Loss</a>
    </div>
  </li>
