            ...
            <form action="post.php" method="post" autocomplete="off">
                ...
                <div class="modal-body bg-white">
                        ...
                        <div class="tab-pane fade show active" id="pills-overview">
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" class="form-control" name="name" placeholder="Name of Service"
                                        required>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                <label>Notes</label>
                                <textarea class="form-control" rows="3" placeholder="Enter some notes"
                                    name="note"></textarea>
                            </div>
                        </div>

                        <div class="tab-pane fade" id="pills-general">A
                            <div class="form-group">
                        ...
                        <div class="tab-pane fade" id="pills-assets">
                            ...
                            <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control select2" id="certificates" name="certificates[]"
                                        multiple>
                                        <?php
										$sql = mysqli_query(
											$mysqli,
                    ...
                    <div class="modal-footer bg-white">
                        <button type="submit" name="add_service" class="btn btn-primary text-bold"><i
