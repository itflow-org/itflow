            ...
            <form action="post.php" method="post" autocomplete="off">
                ...
                <div class="modal-body bg-white">
                    ...
                    <ul class="nav nav-pills nav-justified mb-3">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" data-toggle="pill" href="#pills-billing<?php echo $service_id ?>">Billing</a>
                        </li>
                    </ul>
                    ...
                    <div class="tab-content">
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    ...
                                    <select class="form-control select2" name="importance" required>
                                        <option <?php if ($service_importance == 'Low') {
                                                    echo "selected";
                                                } ?>>Low</option>
                                        <option <?php if ($service_importance == 'Medium') {
                                                    echo "selected";
                                                } ?>>Medium</option>
                                        <option <?php if ($service_importance == 'High') {
                                                    echo "selected";
                                                } ?>>High</option>
                                    </select>
                                </div>
                        ...
                        <div class="tab-pane fade" id="pills-billing<?php echo $service_id ?>">
                                <div class="form-group">
                                    <label>Price</label>
                                    <div class="input-group">
                                        <div class="input-group-prepend">
                                        ...
                                        <input type="text" class="form-control" name="price" value="<?php echo $service_price; ?>">
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" class="form-control" name="price" value="<?php echo $service_cost; ?>">
                                    </div>
                                </div>
