  ...
  <div class="modal-dialog">
    <div class="modal-content bg-dark">
      <div class="modal-header">
        <h5 class="modal-title text-white"><i class="fa fa-fw fa-route mr-2"></i>Edit Trip</h5>
      ...
      <form action="post.php" method="post" autocomplete="off">
        <div class="modal-body bg-white">
          ...
          <ul class="nav nav-pills nav-justified mb-3" id="pills-tab<?php echo $trip_id; ?>" role="tablist">
            <li class="nav-item">
          ...
          <div class="tab-content" id="pills-tabContent<?php echo $trip_id; ?>">

            <div class="tab-pane fade show active" id="pills-basic<?php echo $trip_id; ?>" role="tabpanel" aria-labelledby="pills-basic-tab">
