        ...
        <div class="modal-content bg-dark">
            <div class="modal-header">
                <h5 class="modal-title"><i class="fa fa-fw fa-boxes mr-2"></i>
                    <?php if($ticket_status != "Closed") { ?>Edit<?php } else { ?>View<?php } ?> products on Ticket: <?php echo $ticket_prefix.$ticket_number; ?>
                </h5>
                    ...
                    <div class="row">
                        ...
                        <div class="tab-content">
                            <div class="tab-pane container show active" id="pills-expense">
                                ...
                                <?php if ($ticket_status != "Closed") { ?>
                                        <div class="md-6">
                                            <label for="expenses">Select Expense to Add</label>
                                            <select name="expense" id="expense" class="form-control form-control-sm">
