        ...
        <div class="modal-content bg-dark">
            ...
            <form action="post.php" method="post" autocomplete="off">
                    ...
                    <ul class="list-group">
                        <div class="row">
                            <div class="col-sm-6">
                                ...
                                <li class="list-group-item">
                                    <div class="custom-control custom-checkbox">
                                        <input class="custom-control-input" type="checkbox" id="contacts"
                                            name="export_contacts" value="1" checked>
                                ...
                                <li class="list-group-item">
                                    <div class="custom-control custom-checkbox">
                                        <input class="custom-control-input" type="checkbox" id="locations"
                                            name="export_locations" value="1" checked>
                                ...
                                <li class="list-group-item">
                                    <div class="custom-control custom-checkbox">
                                        <input class="custom-control-input" type="checkbox" id="assets"
                                            name="export_assets" value="1" checked>
                                ...
                                <li class="list-group-item">
                                    <div class="custom-control custom-checkbox">
                                        <input class="custom-control-input" type="checkbox" id="software"
                                            name="export_software" value="1" checked>
                                ...
                                <li class="list-group-item">
                                    <div class="custom-control custom-checkbox">
                                        <input class="custom-control-input" type="checkbox" id="logins"
                                            name="export_logins" value="1">
                                ...
                                <li class="list-group-item">
                                    <div class="custom-control custom-checkbox">
                                        <input class="custom-control-input" type="checkbox" id="networks"
                                            name="export_networks" value="1" checked>
                                ...
                                <li class="list-group-item">
                                    <div class="custom-control custom-checkbox">
                                        <input class="custom-control-input" type="checkbox" id="certificates"
                                            name="export_certificates" value="1" checked>
                                ...
                                <li class="list-group-item">
                                    <div class="custom-control custom-checkbox">
                                        <input class="custom-control-input" type="checkbox" id="domains"
                                            name="export_domains" value="1" checked>
                                ...
                                <li class="list-group-item">
                                    <div class="custom-control custom-checkbox">
                                        <input class="custom-control-input" type="checkbox" id="tickets"
                                            name="export_tickets" value="1" checked>
                            ...
                            <div class="col-sm-6">
                                ...
                                <li class="list-group-item">
                                    <div class="custom-control custom-checkbox">
                                        <input class="custom-control-input" type="checkbox" id="scheduled_tickets"
                                            name="export_scheduled_tickets" value="1" checked>
                                ...
                                <li class="list-group-item">
                                    <div class="custom-control custom-checkbox">
                                        <input class="custom-control-input" type="checkbox" id="vendors"
                                            name="export_vendors" value="1" checked>
                                ...
                                <li class="list-group-item">
                                    <div class="custom-control custom-checkbox">
                                        <input class="custom-control-input" type="checkbox" id="invoices"
                                            name="export_invoices" value="1" checked>
                                ...
                                <li class="list-group-item">
                                    <div class="custom-control custom-checkbox">
                                        <input class="custom-control-input" type="checkbox" id="recurring"
                                            name="export_recurring" value="1" checked>
                                ...
                                <li class="list-group-item">
                                    <div class="custom-control custom-checkbox">
                                        <input class="custom-control-input" type="checkbox" id="quotes"
                                            name="export_quotes" value="1" checked>
                                ...
                                <li class="list-group-item">
                                    <div class="custom-control custom-checkbox">
                                        <input class="custom-control-input" type="checkbox" id="payments"
                                            name="export_payments" value="1" checked>
                                ...
                                <li class="list-group-item">
                                    <div class="custom-control custom-checkbox">
                                        <input class="custom-control-input" type="checkbox" id="trips"
                                            name="export_trips" value="1" checked>
                                ...
                                <li class="list-group-item">
                                    <div class="custom-control custom-checkbox">
                                        <input class="custom-control-input" type="checkbox" id="logs" name="export_logs"
                                            value="1" checked>
                ...
                <div class="modal-footer bg-white">
                    <button type="submit" name="export_client_pdf" class="btn btn-primary text-bold"><i
                            class="fa fa-fw fa-download mr-2"></i>Export</button>
