        ...
        <div class="modal-content bg-dark">
            <div class="modal-header">
                <h5 class="modal-title">
                    ...
                    Editing asset: <strong><?php echo $asset_name; ?></strong>
                </h5>
            ...
            <form action="post.php" method="post" autocomplete="off">
                    ...
                    <ul class="nav nav-pills nav-justified mb-3">
                        <li class="nav-item">
                            <a class="nav-link active" data-toggle="pill"
                                href="#pills-details<?php echo $asset_id; ?>">Details
                            </a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" data-toggle="pill"
                                href="#pills-assignment<?php echo $asset_id; ?>">Assignment
                            </a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" data-toggle="pill"
                                href="#pills-purchase<?php echo $asset_id; ?>">Purchase
                            </a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" data-toggle="pill"
                                href="#pills-login<?php echo $asset_id; ?>">Login
                            </a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" data-toggle="pill"
                                href="#pills-notes<?php echo $asset_id; ?>">Notes
                            </a>
                        </li>
                    </ul>
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    ...
                                    <select class="form-control select2" name="type" required>
                                        <?php foreach(
                                            $asset_types_array as $asset_type_select => $asset_icon_select
                                            ) { ?>
                                            <option <?php if ($asset_type_select == $asset_type) {
                                                echo "selected";
                                                } ?>><?php echo $asset_type_select; ?></option>
                                        <?php } ?>
                                    </select>
                                </div>
                            </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" class="form-control" name="make"
                                            placeholder="Manufacturer" value="<?php echo $asset_make; ?>">
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" class="form-control" name="serial"
                                            placeholder="Serial number" value="<?php echo $asset_serial; ?>">
                                    </div>
                                </div>
                            <?php } ?>
                                ...
                                <div class="input-group">
                                    ...
                                    <select class="form-control select2" name="location">
                                        ...
                                        $sql_locations = mysqli_query(
                                            ...
                                            (location_archived_at > '$asset_created_at' OR location_archived_at IS NULL)
                                            AND location_client_id = $client_id
                                            ORDER BY location_archived_at ASC, location_name ASC"
                                            );
                                        while ($row = mysqli_fetch_array($sql_locations)) {
                                            ...
                                            <option <?php if ($asset_location_id == $location_id_select) {
                                                ...
                                                <?php echo "$location_archived_display$location_name_select"; ?>
                                            </option>
                                ...
                                <div class="input-group">
                                    ...
                                    <select class="form-control select2" name="contact">
                                        ...
                                        $sql_contacts = mysqli_query(
                                            ...
                                            (contact_archived_at > '$asset_created_at' OR contact_archived_at IS NULL)
                                        ...
                                        while ($row = mysqli_fetch_array($sql_contacts)) {
                                            ...
                                            ?>
                                            <option <?php if ($asset_contact_id == $contact_id_select) {
                                                echo "selected";
                                ...
                                <div class="input-group">
                                    ...
                                    <select class="form-control select2" name="network">
                                        ...
                                        $sql_networks = mysqli_query(
                                            ...
                                            (network_archived_at > '$asset_created_at' OR network_archived_at IS NULL)
                                            AND network_client_id = $client_id
                                            ORDER BY network_archived_at ASC, network_name ASC"
                                        );
                                        while ($row = mysqli_fetch_array($sql_networks)) {
                                            ...
                                            <option <?php if ($asset_network_id == $network_id_select) {
                                                ...
                                                <?php echo "$network_archived_display$network_name_select"; ?>
                                                - <?php echo $network_select; ?>
                                            </option>
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" class="form-control" name="ip"
                                        value="<?php echo $asset_ip; ?>" placeholder="192.168.10.250"
                                        data-inputmask="'alias': 'ip'" data-mask>
                                    <div class="input-group-append">
                                        <div class="input-group-text">
                                            <input type="checkbox" name="dhcp"
                                            value="1" <?php if($asset_ip == 'DHCP'){
                                                echo "checked";
                                                } ?>>
                                        </div>
                                    </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" class="form-control" name="mac"
                                        value="<?php echo $asset_mac; ?>" placeholder="MAC Address"
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" class="form-control" name="uri"
                                        placeholder="URI http:// ftp:// ssh: etc" value="<?php echo $asset_uri; ?>">
                                </div>
                            </div>
                                ...
                                <div class="input-group">
                                    ...
                                    <select class="form-control select2" name="vendor">
                                        ...
                                        $sql_vendors = mysqli_query($mysqli,
                                            ...
                                            (vendor_archived_at > '$asset_created_at' OR vendor_archived_at IS NULL) AND
                                            vendor_client_id = $client_id
                                            ORDER BY vendor_archived_at ASC, vendor_name ASC"
                                        );
                                        while ($row = mysqli_fetch_array($sql_vendors)) {
                                            ...
                                            <option <?php if ($asset_vendor_id == $vendor_id_select) {
                                                ...
                                                <?php echo "$vendor_archived_display$vendor_name_select"; ?>
                                            </option>
                                        <?php } ?>
                                    </select>
                                </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" class="form-control" name="username"
                                        placeholder="Username" value="<?php echo $login_username; ?>">
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" class="form-control" name="password" placeholder="Password"
                                        value="<?php echo $login_password; ?>" autocomplete="new-password">
                                </div>
                            </div>
                ...
                <div class="modal-footer bg-white">
                    <button type="submit" name="edit_asset" class="btn btn-primary text-bold">
