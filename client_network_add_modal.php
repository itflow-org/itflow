            ...
            <form action="post.php" method="post" autocomplete="off">
                ...
                <div class="modal-body bg-white">
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-group">
                            ...
                            <input type="text" class="form-control" name="name"
                                placeholder="Network name (VLAN, WAN, LAN2 etc)" required autofocus>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-group">
                            ...
                            <input type="text" class="form-control" inputmode="numeric" pattern="[0-9]*" name="vlan"
                                placeholder="ex. 20">
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-group">
                            ...
                            <input type="text" class="form-control" name="gateway" placeholder="ex 192.168.1.1"
                                data-inputmask="'alias': 'ip'" data-mask required>
                        </div>
                    </div>
                ...
                $sql = mysqli_query(
                  ...
                  "SELECT * FROM locations
					WHERE location_archived_at IS NULL
                ...
                <div class="modal-footer bg-white">
                    <button type="submit" name="add_network" class="btn btn-primary text-bold"><i
