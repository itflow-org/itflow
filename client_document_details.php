...
<ol class="breadcrumb d-print-none">
    ...
    <li class="breadcrumb-item">
        <a href="client_documents.php?client_id=<?php echo $client_id; ?>&folder_id=<?php echo $document_folder_id; ?>">
            <i class="fas fa-fw fa-folder-open mr-2"></i><?php echo $folder_name; ?>
        </a>
    </li>
    <?php } ?>
    <li class="breadcrumb-item active"><i class="fas fa-file"></i> <?php echo $document_name; ?>
    ...
    <div class="col-md-9">
        <div class="card">
            <div class="card-header bg-dark">
                ...
                <h3><?php echo $document_name; ?> <?php if (!empty($document_description)) {
						?><span class="h6 text-muted">(<?php echo $document_description; ?>)</span><?php
						} ?></h3>

                <div class="row">
                    <div class="col"><strong>Date:</strong>
                        <?php echo date('Y-m-d', strtotime($document_created_at)); ?></div>
    ...
    <div class="col-md-3 d-print-none">
        <div class="card card-body bg-light">
            <button type="button" class="btn btn-primary btn-block" data-toggle="modal"
                data-target="#editDocumentModal<?php echo $document_id; ?>">
            ...
            <button type="button" class="btn btn-secondary btn-block" onclick="window.print();"><i
                    class="fas fa-fw fa-print mr-2"></i>Print</button>
            <hr>
            <h5 class="mb-3">Related</h5>
            <h6>
                <i class="fas fa-fw fa-paperclip text-secondary mr-2"></i>Files
                <button type="button" class="btn btn-link btn-sm" data-toggle="modal"
                    data-target="#linkFileToDocumentModal">
        ...
        while ($row = mysqli_fetch_array($sql_files)) {
			...
			?>
                <li>
                    <?php echo $file_name; ?>
                    <a
                        href="post.php?unlink_file_from_document&
							file_id=<?php echo $file_id; ?>&document_id=<?php echo $document_id; ?>">
            ...
            <h6>
                ...
                <button type="button" class="btn btn-link btn-sm" data-toggle="modal"
                    data-target="#linkContactToDocumentModal">
                    <i class="fas fa-fw fa-plus"></i>
                </button>
            </h6>
            <ul>
        ...
        while ($row = mysqli_fetch_array($sql_contacts)) {
			...
			?>
                <li>
                    ...
                    <a
                        href="post.php?unlink_contact_from_document&
							contact_id=<?php echo $contact_id; ?>&document_id=<?php echo $document_id; ?>">
                        <i class="fas fa-fw fa-times text-secondary ml-2"></i>
                    </a>
                </li>
                <?php
            ...
            <h6>
                ...
                <button type="button" class="btn btn-link btn-sm" data-toggle="modal"
                    data-target="#linkAssetToDocumentModal">
                    <i class="fas fa-fw fa-plus"></i>
                </button>
            </h6>
            <ul>
        ...
        while ($row = mysqli_fetch_array($sql_assets)) {
			...
			?>
                <li>
                    <?php echo $asset_name; ?>
                    <a
                        href="post.php?unlink_asset_from_document&
							asset_id=<?php echo $asset_id; ?>&document_id=<?php echo $document_id; ?>">
                        <i class="fas fa-fw fa-times text-secondary ml-2"></i>
                    </a>
                </li>
                <?php
            ...
            <h6>
                ...
                <button type="button" class="btn btn-link btn-sm" data-toggle="modal"
                    data-target="#linkSoftwareToDocumentModal">
                    <i class="fas fa-fw fa-plus"></i>
                </button>
            </h6>
            <ul>
        ...
        while ($row = mysqli_fetch_array($sql_software)) {
			...
			?>
                <li>
                    ...
                    <a
                        href="post.php?unlink_software_from_document&
							software_id=<?php echo $software_id; ?>&document_id=<?php echo $document_id; ?>">
                        <i class="fas fa-fw fa-times text-secondary ml-2"></i>
                    </a>
                </li>
                <?php
            ...
            <h6>
                ...
                <button type="button" class="btn btn-link btn-sm" data-toggle="modal"
                    data-target="#linkVendorToDocumentModal">
                    <i class="fas fa-fw fa-plus"></i>
                </button>
            </h6>
            <ul>
        ...
        while ($row = mysqli_fetch_array($sql_vendors)) {
			...
			?>
                <li>
                    ...
                    <a
                        href="post.php?unlink_vendor_from_document&
							vendor_id=<?php echo $vendor_id; ?>&document_id=<?php echo $document_id; ?>">
                        <i class="fas fa-fw fa-times text-secondary ml-2"></i>
                    </a>
                </li>
                <?php
      	...
      	while ($row = mysqli_fetch_array($sql_document_revisions)) {
			...
			?>
				<div class="mt-1 <?php if($document_id == $revision_document_id){ echo "text-bold"; } ?>">
					...
					<a href="?client_id=<?php echo $client_id; ?>
							&document_id=<?php echo $revision_document_id; ?>">
							<?php echo "$revision_document_created_date"; ?>
					</a><?php if($document_parent == $revision_document_id){ echo " (Parent)"; } ?>
