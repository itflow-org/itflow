...
$document_is_public = intval($row['document_is_public']);
...
<ol class="breadcrumb d-print-none">
    ...
    <?php } ?>
    <li class="breadcrumb-item active"><i class="fas fa-file"></i> <?php echo $document_name; ?> <?php if (!empty($document_archived_at)) {
        ...
        <div class="card">
            <div class="card-header bg-dark">
                ...
                <div class="row">
                    ...
                    <div class="col">
                    <strong>Document Public to Client:</strong>
                        <?php
                        if ($document_is_public == 0) {
                            echo "No";
                        } elseif ($document_is_public == 1) {
                            echo "Yes";
                        };
                        ?>
                    </div>
            ...
            <div class="card-body prettyContent">
                ...
                <table class="table table-sm">
                    ...
                    <tbody>
                        <?php
                        $sql_document_revisions = mysqli_query(
                            $mysqli,
                            "SELECT * FROM documents
                            LEFT JOIN users ON document_created_by = user_id
    ...
    <div class="col-md-3 d-print-none">
        <div class="row">
            <div class="col-12 mb-3">
                ...
                <button type="button" class="btn btn-secondary mr-2" data-toggle="modal" data-target="#shareModal" onclick="populateShareModal(<?php echo "$client_id, 'Document', $document_id"; ?>)">
        ...
        <div class="card card-body bg-light">
            ...
            $sql_files = mysqli_query(
                $mysqli,
                "SELECT * FROM files, document_files
            ...
            $sql_contacts = mysqli_query(
                $mysqli,
                "SELECT * FROM contacts, contact_documents
            ...
            $sql_assets = mysqli_query(
                $mysqli,
                "SELECT * FROM assets, asset_documents
            ...
            $sql_software = mysqli_query(
                $mysqli,
                "SELECT * FROM software, software_documents
            ...
            $sql_vendors = mysqli_query(
                $mysqli,
                "SELECT * FROM vendors, vendor_documents
        ...
        <div class="card card-body bg-light">
            ...
            ?>
                <div class="mt-1 <?php if ($document_id == $revision_document_id) {
                                        echo "text-bold";
                                    } ?>">
                    <i class="fas fa-fw fa-history text-secondary mr-2"></i><a href="?client_id=<?php echo $client_id; ?>&document_id=<?php echo $revision_document_id; ?>"><?php echo "  $revision_document_created_date"; ?></a><?php if ($document_parent == $revision_document_id) {
                                                                                                                                                                                                                                        echo "<span class='float-right'>(Parent)</span>";
                                                                                                                                                                                                                                    } else { ?>
