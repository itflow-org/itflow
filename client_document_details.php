...
<div class="row">
    ...
    <div class="col-md-3 d-print-none">
        <div class="card card-body bg-light">
            ...
            <button type="button" class="btn btn-secondary btn-block" data-toggle="modal" data-target="#shareModal" onclick="populateShareModal(<?php echo "$client_id, 'Document', $document_id"; ?>)">
