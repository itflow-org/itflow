...
function updateTicket(
    ...
    $ticket_id = intval($parameters['ticket_id']);
    $ticket_data = readTicket(['ticket_id' => $parameters['ticket_id']]);    
    ...
    $asset_id = isset($parameters['ticket_asset']) ? intval($parameters['ticket_asset']) : $ticket_data['ticket_asset_id'];
    ...
    $schedule = isset($parameters['ticket_schedule']) ? sanitizeInput($parameters['ticket_schedule']) : $ticket_data['ticket_schedule'];
    $on_site = isset($parameters['ticket_on_site']) ? sanitizeInput($parameters['ticket_on_site']) : $ticket_data['ticket_on_site'];
    ...
    mysqli_query($mysqli, "UPDATE tickets SET
