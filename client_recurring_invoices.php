            ...
            <table class="table table-striped table-borderless table-hover">
                ...
                <tr>
                    ...
                    $recurringColumns = [
                        ...
                        'recurring_amount' => ['Amount', 'text-right'],
                    ...
                    foreach ($recurringColumns as $sortParam => $columnData) {
                        list($columnName, $class) = $columnData;
                        ...
                        echo "<th$classAttribute><a class='text-secondary' href='?
