...
<div class="card card-dark">
    <div class="card-header">
        <h3 class="card-title"><i class="fas fa-fw fa-sign-in-alt mr-2"></i><?php echo lang('recent_sign_ins'); ?></h3>
    </div>
    <table class="table table-borderless">
        <tbody>
        <?php while ($row = mysqli_fetch_array($sql_recent_logins)) { 
    ...
    <div class="card-footer">
        <a href="admin_audit_log.php?q=<?php echo "$session_name successfully logged in"; ?>">
...
<div class="card card-dark">
    <div class="card-header">
        <h3 class="card-title"><i class="fas fa-fw fa-history mr-2"></i><?php echo lang('recent_activity'); ?></h3>
    </div>
    <table class="table">
        <tbody>
        <?php while ($row = mysqli_fetch_array($sql_recent_logs)) { 
            $log_id = intval($row['log_id']);
    ...
    <div class="card-footer">
        <a href="admin_audit_log.php?q=<?php echo nullable_htmlentities($session_name); ?>">
            <?php echo lang('see_more'); ?>...
        </a>
    </div>
</div>
