...
$sql = mysqli_query(
    ...
    AND (vendor_name LIKE '%$q%'
    OR client_name LIKE '%$q%'
    OR category_name LIKE '%$q%'
    OR account_name LIKE '%$q%'
    OR expense_description LIKE '%$q%'
    OR expense_amount LIKE '%$q%')
...
<div class="card card-dark">
    <div class="card-header py-2">
        ...
        <div class="card-tools">
            <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#addExpenseModal"><i
                    class="fas fa-plus mr-2"></i>New Expense</button>
        </div>
    </div>
        ...
        <form class="mb-4" autocomplete="off">
            ...
            <div class="collapse mt-3 <?php if (!empty($_GET['dtf']) || $_GET['canned_date'] !== "custom" ) {
                ...
                <div class="row">
                    <div class="col-md-2">
                        <div class="form-group">
                            ...
                            <select class="form-control select2" name="canned_date">
                                <option <?php if ($_GET['canned_date'] == "custom") { echo "selected"; } ?> value="">
                                    Custom</option>
                    ...
                    <div class="col-md-6">
                        <div class="float-right">
                            <button type="button" class="btn btn-default mt-4" data-toggle="modal"
                                data-target="#exportExpensesModal"><i
                ...
                <thead class="text-dark <?php if ($num_rows[0] == 0) { echo "d-none"; } ?>">
                    <tr>
                        <th><a class="text-dark"
                                ...
                                &sort=expense_date&order=<?php echo $disp; ?>">Date</a>
                        </th>
                        <th><a class="text-dark"
                                href="?<?php echo $url_query_strings_sort; ?>
                                &sort=vendor_name&order=<?php echo $disp; ?>">Vendor</a>
                        </th>
                        <th><a class="text-dark"
                                href="?<?php echo $url_query_strings_sort; ?>
                        ...
                        <th><a class="text-dark"
                                href="?<?php echo $url_query_strings_sort; ?>
                                &sort=expense_description&order=<?php echo $disp; ?>">Description</a>
                        </th>
                        <th class="text-right"><a class="text-dark"
                                href="?<?php echo $url_query_strings_sort; ?>
                                &sort=expense_amount&order=<?php echo $disp; ?>">Amount</a>
                        </th>
                        <th><a class="text-dark"
                                href="?<?php echo $url_query_strings_sort; ?>
                        ...
                        <th><a class="text-dark"
                                href="?<?php echo $url_query_strings_sort; ?>
                                &sort=client_name&order=<?php echo $disp; ?>">Client</a>
                        </th>
                ...
                <tbody>
                    ...
                    while ($row = mysqli_fetch_array($sql)) {
                        ...
                        if (empty($expense_receipt)) {
                            ...
                            $receipt_attached = "<a class='text-secondary mr-2'
                            target='_blank' href='uploads/expenses/$expense_receipt'
                    ...
                    <tr>
                        <td><?php echo $receipt_attached; ?>
                            <a class="text-dark" href="#" data-toggle="modal"
                                data-target="#editExpenseModal<?php echo $expense_id; ?>">
                        ...
                        <td class="text-bold text-right">
                            <?php echo numfmt_format_currency($currency_format, $expense_amount, $expense_currency_code); ?>
                        </td>
                            ...
                            <div class="dropdown dropleft text-center">
                                ...
                                <div class="dropdown-menu">
                                    ...
                                    <a class="dropdown-item" 
                                        href="<?php echo "uploads/expenses/$expense_receipt"; ?>" download="
                                    ...
                                    <a class="dropdown-item" href="#" data-toggle="modal"
                                        data-target="#addExpenseCopyModal<?php echo $expense_id; ?>">
                                        <i class="fas fa-fw fa-copy mr-2"></i>Copy
                                    </a>
                                    <div class="dropdown-divider"></div>
                                    <a class="dropdown-item" href="#" data-toggle="modal"
                                        data-target="#addExpenseRefundModal<?php echo $expense_id; ?>">
                                        <i class="fas fa-fw fa-undo-alt mr-2"></i>Refund
                                    </a>
                                    <div class="dropdown-divider"></div>
                                    <a class="dropdown-item text-danger text-bold confirm-link"
                                        href="post.php?delete_expense=<?php echo $expense_id; ?>">
