...
$invoices_sql = mysqli_query($mysqli, "SELECT * FROM invoices WHERE invoice_client_id = $session_client_id AND (NOT invoice_status = 'Draft' ORDER BY invoice_date DESC");
?>
