...
?>
    ...
    <div class="card card-dark">
        <div class="card-header">
            <h3 class="card-title"><i class="fa fa-fw fa-address-book mr-2"></i>Contacts</h3>
        </div>
        <div class="card-body">
                    ...
                    <div class="col-md-2">
                        <div class="input-group">
                            <select class="form-control select2" name="location" onchange="this.form.submit()">
                                ...
                                <?php
                                $sql_locations_filter = mysqli_query($mysqli, "SELECT * FROM locations WHERE location_archived_at IS NULL ORDER BY location_name ASC");
