        ...
        <div class="modal-content bg-dark">
            ...
            <form action="post.php" method="post" autocomplete="off">
                        ...
                        <div class="tab-pane fade show active" id="pills-details">
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="password" class="form-control" data-toggle="password" id="password"
                                        name="password" placeholder="Password" required autocomplete="new-password">
                                    <div class="input-group-append">
                                        <span class="input-group-text"><i class="fa fa-fw fa-eye"></i></span>
                                    </div>
                                    <div class="input-group-append">
                                        <span class="btn btn-default"><i class="fa fa-fw fa-question"
                                                onclick="generatePassword()"></i></span>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="input-group">
                                    ...
                                    <select class="form-control select2" name="software">
                                        ...
                                        while ($row = mysqli_fetch_array($sql)) {
                                            ...
                                            ?>
                                        <option value="<?php echo $software_id; ?>"><?php echo $software_name; ?>
                                        </option>
                ...
                <div class="modal-footer bg-white">
                    <button type="submit" name="add_login" class="btn btn-primary text-bold"><i
