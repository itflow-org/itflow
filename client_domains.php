                ...
                <thead class="text-dark <?php if ($num_rows[0] == 0) { echo "d-none"; } ?>">
                    <tr>
                        <th><a class="text-secondary" 
                            href="?<?php echo $url_query_strings_sort; ?>&sort=domain_name&order=
                            <?php echo $disp; ?>">Domain</a></th>
                        <th><a class="text-secondary" 
                            href="?<?php echo $url_query_strings_sort; ?>&sort=vendor_name&order=
                            <?php echo $disp; ?>">Registrar</a></th>
                        <th>Web Host</th>
                        <th><a class="text-secondary" 
                            href="?<?php echo $url_query_strings_sort; ?>&sort=domain_expire&order=
                            <?php echo $disp; ?>">Expires</a></th>
                ...
                <tbody>
                    ...
                    while ($row = mysqli_fetch_array($sql)) {
                        ...
                        $sql_domain_webhost = mysqli_query(
                            ...
                            WHERE vendor_id = $domain_webhost"
                            );
                    ...
                    <tr>
                        <td><a class="text-dark" href="#" data-toggle="modal"
                                onclick="populateDomainEditModal(<?php echo $client_id, ",", $domain_id ?>)"
                                data-target="#editDomainModal"><?php echo $domain_name; ?></a></td>
                            ...
                            <div class="dropdown dropleft text-center">
                                ...
                                <div class="dropdown-menu">
                                    ...
                                    <a class="dropdown-item text-danger"
                                        href="post.php?archive_domain=<?php echo $domain_id; ?>">
                                    ...
                                    <a class="dropdown-item text-danger text-bold"
                                        href="post.php?delete_domain=<?php echo $domain_id; ?>">
