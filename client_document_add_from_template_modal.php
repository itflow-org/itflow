    ...
    <div class="modal-dialog">
        <div class="modal-content bg-dark">
            ...
            <form action="post.php" method="post" autocomplete="off">
                ...
                ?>
                                <option value="<?php echo $document_template_id ?>">
                                    <?php echo $document_template_name; ?></option>
                                <?php
                }
                ?>
                ...
                ?>
                                <option
                                    <?php if (isset($_GET['folder_id']) && $_GET['folder_id'] == $folder_id) {
										echo "selected";
										}?>
                ...
                <div class="modal-footer bg-white">
                    <button type="submit" name="add_document_from_template" class="btn btn-primary text-bold"><i
                            class="fa fa-check mr-2"></i>Create & edit</button>
