    ...
    <div class="modal-dialog">
        <div class="modal-content bg-dark">
            <div class="modal-header">
                <h5 class="modal-title"><i class="fa fa-fw fa-<?php echo $file_icon; ?> mr-2"></i>Moving File:
                    <strong><?php echo $file_name; ?></strong></h5>
            ...
            <form action="post.php" method="post" autocomplete="off">
                        ...
                        <div class="input-group">
                            ...
                            <select class="form-control" name="folder_id">
                                ...
                                while ($row = mysqli_fetch_array($sql_folders_select)) {
                                    ...
                                    ?>
                                <option <?php if ($folder_id_select == $document_folder_id) echo "selected"; ?>
                                    value="<?php echo $folder_id_select ?>"> <?php echo $folder_name_select; ?>
                                    </option>
                                <?php
                                }
                                ?>
                ...
                <div class="modal-footer bg-white">
                    <button type="submit" name="move_file" class="btn btn-primary text-bold"><i
                            class="fa fa-check mr-2"></i>Move</button>
