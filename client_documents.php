                        ...
                        <div class="row">
                            <div class="col-10">
                                ...
                                <a class="nav-link <?php if ($get_folder_id == 0) {
                                                        echo "active";
                                                    } ?>" href="?client_id=<?php echo $client_id; ?>&folder_id=0">/ <?php if ($num_documents > 0) {
                            ...
                            <div class="row">
                                <div class="col-10">
                                    <a class="nav-link <?php if ($get_folder_id == $folder_id) {
                                                            echo "active";
                                                        } ?> " href="?client_id=<?php echo $client_id; ?>&folder_id=<?php echo $folder_id; ?>">
                                        <?php
                ...
                <form id="bulkActions" action="post.php" method="post">
                    ...
                    <div class="table-responsive-sm">
                        <table class="table table-border">
                            <thead class="thead-light <?php if ($num_rows[0] == 0) {
                                                            echo "d-none";
                                                        } ?>">
                                <tr>
                                    ...
                                    <th>
                                        <a class="text-secondary" href="?<?php echo $url_query_strings_sort; ?>&sort=document_updated_at&order=<?php echo $disp; ?>">Document Is Public</a>
                                    </th>
