            ...
            <form action="post.php" method="post" enctype="multipart/form-data" autocomplete="off">
                            ...
                            <div class="input-group">
                                ...
                                <select class="form-control select2" name="account" required>
                                    ...
                                    $sql_accounts = mysqli_query(
                                        $mysqli,
                                        "SELECT account_id, account_name, opening_balance FROM accounts
                                    ...
                                    while ($row = mysqli_fetch_array($sql_accounts)) {
                                        ...
                                        ?>
                                    <option <?php if ($expense_account_id == $account_id_select) { echo "selected"; } ?>
                                        value="<?php echo $account_id_select; ?>"><?php echo $account_name_select; ?>
                            ...
                            <div class="input-group">
                                ...
                                <select class="form-control select2" name="vendor" required>
                                    ...
                                    $sql_vendors = mysqli_query(
                                        ...
                                        WHERE vendor_client_id = 0 AND vendor_template = 0
                ...
                <div class="modal-footer bg-white">
                    <button type="submit" name="add_expense" class="btn btn-primary text-bold"><i
                            class="fa fa-check mr-2"></i>Copy</button>
