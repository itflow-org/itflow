        ...
        <div class="modal-content bg-dark">
            <div class="modal-header">
                <h5 class="modal-title">
                    <i class="fa fa-fw fa-<?php echo $device_icon; ?> mr-2"></i><?php echo $asset_name; ?> Documents
                </h5>
            ...
            <div class="modal-body bg-white">
                ...
                while ($row = mysqli_fetch_array($sql_related_documents)) {
                    ...
                    <p>
                        ...
                        <?php echo $related_document_name; ?>
                        <a href="client_documents.php?q=<?php echo $related_document_name; ?>">
                            <?php echo $related_document_name; ?>
                        </a>
                    </p>
                <?php } ?>
