            ...
            <div class="table-responsive">
                <table class="table table-striped">
                    ...
                    while ($row = mysqli_fetch_array($sql_clients)) {
                        ...
                        $sql_ticket_closed_count = mysqli_query($mysqli, "SELECT COUNT(ticket_id) AS ticket_closed_count FROM tickets WHERE YEAR(ticket_created_at) = $year AND ticket_client_id = '$client_id' AND ticket_status = 'Closed' AND ticket_closed_at IS NOT NULL");
