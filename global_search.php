            ...
            <div class="card-body">
                <table class="table table-striped table-borderless">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td><a
                                    href="client_overview.php?client_id=<?php echo $client_id; ?>"><?php echo $client_name; ?></a>
                            </td>
                    ...
                    <tbody>
                        <?php
                            ...
                            while ($row = mysqli_fetch_array($sql_contacts)) {
                                ...
                                ?>
                        <tr>
                            <td><a href="client_contact_details.php?client_id=<?php echo $client_id; ?>
                                    &contact_id=<?php echo $contact_id; ?>"><?php echo $contact_name; ?></a>
                            ...
                            <td><a href="client_overview.php?client_id=<?php echo $client_id; ?>">
                ...
                <table class="table table-striped table-borderless">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td><a href="client_vendors.php?client_id=<?php echo $client_id; ?>">
                                <?php echo $client_name; ?></a>
                            </td>
                        </tr>
                    ...
                    <tbody>
                        <?php
                            ...
                            while ($row = mysqli_fetch_array($sql_domains)) {
                                ...
                                ?>
                        <tr>
                            <td><a href="client_domains.php?client_id=<?php echo $client_id; ?>
                                &domain_id=<?php echo $domain_id; ?>"><?php echo $domain_name; ?></a>
                    ...
                    <tbody>
                        <?php
                            ...
                            while ($row = mysqli_fetch_array($sql_documents)) {
                                ...
                                ?>
                        <tr>
                            <td><a href="client_document_details.php?client_id=<?php echo $client_id ?>
                                &document_id=<?php echo $document_id; ?>"><?php echo $document_name; ?></a>
                            </td>
                            <td>
                ...
                <table class="table table-striped table-borderless">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td><a href="client_tickets.php?client_id=<?php echo $client_id ?>">
                                <?php echo $client_name; ?></a>
                            </td>
                        </tr>
                    ...
                    <tbody>
                        <?php
                            ...
                            while ($row = mysqli_fetch_array($sql_logins)) {
                                ...
                                ?>
                        <tr>
                            <td><a href="client_logins.php?client_id=<?php echo $login_client_id ?>
                                &q=<?php echo $q ?>"><?php echo $login_name; ?></a>
                            </td>
                            <td><?php echo $login_description; ?></td>
                            <td><?php echo $login_username; ?></td>
                            <td><a tabindex="0" class="btn btn-sm" data-toggle="popover" data-trigger="focus"
                                    data-placement="left" data-content="<?php echo $login_password; ?>"><i
                                        class="far fa-eye text-secondary"></i></a><button class="btn btn-sm clipboardjs"
                                    data-clipboard-text="<?php echo $login_password; ?>"><i
                                        class="far fa-copy text-secondary"></i></button>
                            </td>
                            <td><a href="client_logins.php?client_id=<?php echo $client_id; ?>">
                                        <?php echo $client_name; ?></a>
                            </td>
                        </tr>
                ...
                <table class="table table-striped table-borderless">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td><?php echo numfmt_format_currency($currency_format, $invoice_amount, $invoice_currency_code); ?>
                            </td>
                            <td><a href="client_overview.php?client_id=<?php echo $client_id; ?>">
                                <?php echo $client_name; ?></a>
                            </td>
            ...
            <div class="card-body">
                <table class="table table-striped table-borderless">
                    ...
                    <tbody>
                        <?php
                            ...
                            while ($row = mysqli_fetch_array($sql_assets)) {
                                ...
                                if (empty($contact_name)) {
                                    ...
                                    $contact_name_display = "<a href='client_contact_details.php?
                                        client_id=$client_id&contact_id=$contact_id'>$contact_name</a>"; 
                                }
                        ...
                        <tr>
                            <td>
                                <i class="fa fa-fw text-secondary fa-<?php echo $device_icon; ?> mr-2">
                                </i><?php echo $asset_name; ?>
                                <?php if(!empty($asset_uri)){ ?>
                                <a href="<?php echo $asset_uri; ?>" target="_blank"><i
                                        class="fas fa-fw fa-external-link-alt ml-2"></i></a>
                                <?php } ?>
                            </td>
                            <td><?php echo $asset_type; ?></td>
                            <td><?php echo $asset_serial_display; ?></td>
                            <td><a href="client_assets.php?client_id=<?php echo $client_id; ?>">
                                    <?php echo $client_name; ?></a>
                            </td>
