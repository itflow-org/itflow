        ...
        <div class="modal-content bg-dark">
            <div class="modal-header">
                <h5 class="modal-title">
                    ...
                    Editing document: <strong><?php echo $document_name; ?></strong>
                </h5>
            ...
            <form action="post.php" method="post" autocomplete="off">
                <input type="hidden" name="document_id" value="<?php if($document_parent == 0){
                    echo $document_id;
                    } else {
                        echo $document_parent;
                        } ?>">
                ...
                <div class="modal-body bg-white">
                    ...
                    <div class="form-group">
                        <input type="text" class="form-control" name="name"
                            value="<?php echo $document_name; ?>" placeholder="Name" required>
                    </div>
                    ...
                    <div class="form-group">
                        <div class="input-group">
                            ...
                            <select class="form-control" name="folder">
                                ...
                                <?php
                                $sql_folders_select = mysqli_query($mysqli,
                                "SELECT * FROM folders
                                ...
                                while ($row = mysqli_fetch_array($sql_folders_select)) {
                                    ...
                                    <option <?php if ($folder_id_select == $document_folder_id) {
                                        ...
                                        <?php echo $folder_name_select; ?></option>
                                    <?php
                                }
                                ?>
                            </select>
                    ...
                    <div class="form-group">
                        <input type="text" class="form-control" name="description"
                            value="<?php echo $document_description; ?>" placeholder="Short summary of changes">
                    </div>

                </div>
                <div class="modal-footer bg-white">
                    <button type="submit" name="edit_document" class="btn btn-primary text-bold">
