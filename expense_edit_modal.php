                ...
                <div class="modal-body bg-white">
                        ...
                        <div class="form-group col-md">
                            ...
                            <div class="input-group">
                                ...
                                <input type="date" class="form-control" name="date" max="2999-12-31"
                                    value="<?php echo $expense_date; ?>" required>
                            </div>
                        </div>
                        ...
                        <div class="form-group col-md">
                            ...
                            <div class="input-group">
                                ...
                                <input type="text" class="form-control" inputmode="numeric"
                                    ...
                                    value="<?php echo number_format($expense_amount, 2, '.', ''); ?>" placeholder="0.00"
                                    required>
                            </div>
                        </div>
                            ...
                            <div class="input-group">
                                ...
                                <select class="form-control select2" name="account" required>
                                    ...
                                    $sql_accounts = mysqli_query(
                                        $mysqli,
                                        "SELECT account_id, account_name, opening_balance, account_archived_at
                                        FROM accounts
                                        WHERE (account_archived_at > '$expense_created_at'
                                        OR account_archived_at IS NULL)
                                        ORDER BY account_archived_at ASC, account_name ASC");
                                    while ($row = mysqli_fetch_array($sql_accounts)) {
                                        ...
                                        $sql_payments = mysqli_query(
                                            ...
                                            WHERE payment_account_id = $account_id_select"
                                            );
                                        $row = mysqli_fetch_array($sql_payments);
                                        $total_payments = floatval($row['total_payments']);

                                        $sql_revenues = mysqli_query(
                                            $mysqli,
                                            "SELECT SUM(revenue_amount) AS total_revenues FROM revenues
                                            WHERE revenue_account_id = $account_id_select"
                                            );
                                        $row = mysqli_fetch_array($sql_revenues);
                                        $total_revenues = floatval($row['total_revenues']);

                                        $sql_expenses = mysqli_query(
                                            $mysqli,
                                            "SELECT SUM(expense_amount) AS total_expenses FROM expenses
                                            WHERE expense_account_id = $account_id_select"
                                            );
                                        $row = mysqli_fetch_array($sql_expenses);
                                        $total_expenses = floatval($row['total_expenses']);

                                        $balance = $opening_balance + $total_payments
                                        + $total_revenues - $total_expenses;

                                        ?>
                                    <option <?php if ($expense_account_id == $account_id_select) { ?> selected
                                        <?php } ?> value="<?php echo $account_id_select; ?>">
                                        <?php echo "$account_archived_display$account_name_select"; ?>
                                        [$<?php echo number_format($balance, 2); ?>]</option>
                                    <?php
                                    }
                            ...
                            <div class="input-group">
                                ...
                                <select class="form-control select2" name="vendor" required>
                                    ...
                                    $sql_select = mysqli_query(
                                        ...
                                        AND (vendor_archived_at > '$expense_created_at'
                                    ...
                                    while ($row = mysqli_fetch_array($sql_select)) {
                                        ...
                                        ?>
                                    <option <?php if ($expense_vendor_id == $vendor_id_select) { ?> selected <?php } ?>
                                ...
                                <div class="input-group-append">
                                    <a class="btn btn-secondary" href="vendors.php" target="_blank"><i
                    ...
                    <div class="form-group">
                        ...
                        <textarea class="form-control" rows="6" name="description" placeholder="Enter a description"
                            required><?php echo $expense_description; ?></textarea>
                    </div>
                            ...
                            <div class="input-group">
                                ...
                                <select class="form-control select2" name="category" required>
                                    ...
                                    while ($row = mysqli_fetch_array($sql_select)) {
                                        ...
                                        ?>
                                    <option <?php if ($expense_category_id == $category_id_select) { ?> selected
                                        <?php } ?> value="<?php echo $category_id_select; ?>">
                                ...
                                <div class="input-group-append">
                                    <a class="btn btn-secondary" href="categories.php?category=Expense"
                                ...
                                <select class="form-control select2" name="client">
                                    ...
                                    <?php
                                        ...
                                        $sql_clients = mysqli_query(
                                            ...
                                            clients ORDER BY client_name ASC"
                                            );
                                        while ($row = mysqli_fetch_array($sql_clients)) {
                                            $client_id_select = intval($row['client_id']);
                                            $client_name_select = nullable_htmlentities($row['client_name']);
                                            ?>
                                    <option <?php if ($expense_client_id == $client_id_select) { echo "selected"; } ?>
                                        value="<?php echo $client_id_select; ?>"><?php echo $client_name_select; ?>
                                    </option>
                    ...
                    <a class="text-secondary" href="<?php echo "uploads/expenses/$expense_receipt"; ?>"
                        ...
                        <i class="fa fa-fw fa-2x fa-file-pdf text-secondary"></i>
                        <?php echo "$expense_date-$vendor_name-$category_name-$expense_id.pdf" ?>
                    </a>
                    <?php } ?>

                </div>
                <div class="modal-footer bg-white">
                    <button type="submit" name="edit_expense" class="btn btn-primary text-bold"><i
