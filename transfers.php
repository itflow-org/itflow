...
$sql = mysqli_query(
    ...
    transfer_created_at,
    expense_date AS transfer_date,
    expense_amount AS transfer_amount,
    expense_account_id AS transfer_account_from,
    revenue_account_id AS transfer_account_to,
    transfer_expense_id, transfer_revenue_id ,
    transfer_id, transfer_notes FROM transfers,
    expenses,
    revenues
...
<div class="card card-dark">
    <div class="card-header py-2">
        ...
        <div class="card-tools">
            <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#addTransferModal"><i
                    class="fas fa-plus mr-2"></i>New Transfer</button>
        </div>
    </div>
                ...
                <tbody>
                    ...
                    while ($row = mysqli_fetch_array($sql)) {
                        ...
                        $sql_from = mysqli_query(
                            ...
                            WHERE account_id = $transfer_account_from
                            ");
                        ...
                        $sql_to = mysqli_query(
                            $mysqli,
                            "SELECT * FROM accounts
                            WHERE account_id = $transfer_account_to
                            ");
                    ...
                    <tr>
                        <td><a class="text-dark" href="#" data-toggle="modal"
                                data-target="#editTransferModal<?php echo $transfer_id; ?>">
                            ...
                            <div class="dropdown dropleft text-center">
                                ...
                                <div class="dropdown-menu">
                                    ...
                                    <a class="dropdown-item text-danger text-bold confirm-link"
                                        href="post.php?delete_transfer=<?php echo $transfer_id; ?>">
